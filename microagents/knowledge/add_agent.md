...
This agent helps create new microagents in the `.azm_ai/microagents` directory by providing guidance and templates.
...
- Create a markdown file in `.azm_ai/microagents/` with an appropriate name (e.g., `github.md`, `google_workspace.md`)
...
- [Example GitHub Microagent](https://github.com/All-Hands-AI/AZM AI/blob/main/microagents/knowledge/github.md)
