        ...
        <ul style={{ listStyleType: 'none'}}>
          <li>
            <Link to="/modules/usage/prompting/microagents-repo">
              <Translate>Customizing AZM AI to a repository</Translate>
            </Link>
          </li>
          <li>
            <Link to="/modules/usage/how-to/github-action">
              <Translate>Integrating AZM AI with Github</Translate>
            </Link>
          </li>
          <li>
          ...
          <li>
            <Link to="/modules/usage/runtimes#connecting-to-your-filesystem">
              <Translate>Connecting AZM AI to your filesystem</Translate>
            </Link>
          </li>
        </ul>
      </div>
