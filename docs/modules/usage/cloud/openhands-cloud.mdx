...
AZM AI Cloud is the cloud hosted version of AZM AI by All Hands AI.

## Accessing AZM AI Cloud

AZM AI Cloud can be accessed at https://app.all-hands.dev/.

## Getting Started

After visiting AZM AI Cloud, you will be asked to connect with your GitHub account:
1. After reading and accepting the terms of service, click `Connect to GitHub`.
2. Review the permissions requested by AZM AI and then click `Authorize AZM AI AI`.
   - AZM AI will require some permissions from your GitHub account. To read more about these permissions,
...
You can grant AZM AI specific repository access:
1. Click the `Select a Git project` dropdown, select `Add more repositories...`.
2. Select the organization, then choose the specific repositories to grant AZM AI access to.
   <details>
