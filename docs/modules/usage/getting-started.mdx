# Getting Started with AZM AI

So you've [run AZM AI](./installation) and have
[set up your LLM](./installation#setup). Now what?

AZM AI can assist with a range of engineering tasks. However, the technology is still new, and we’re far from having
...
AZM AI is great at adding new code to an existing codebase.

For instance, you can ask AZM AI to add a GitHub action that lints your code. It might check your codebase to
...
Some tasks need more context. While AZM AI can use commands like ls and grep to search, providing context upfront
...
AZM AI does great at refactoring code in small chunks. Rather than rearchitecting the entire codebase,
...
AZM AI can help track down and fix bugs, but bug fixing can be tricky and often requires more context.
It’s helpful if you’ve already diagnosed the issue and just need AZM AI to handle the logic.
...
AZM AI can assist with nearly any coding task, but it takes some practice to get the best results.
...
See [Prompting Best Practices](./prompting/prompting-best-practices) for more tips on how to get the most out of AZM AI.
