...
This guide provides an overview of how to integrate your own evaluation benchmark into the AZM AI framework.

## Setup Environment and LLM Configuration

Please follow instructions [here](https://github.com/All-Hands-AI/AZM AI/blob/main/Development.md) to setup your local development environment.
AZM AI in development mode uses `config.toml` to keep track of most configurations.
...
## How to use AZM AI in the command line

AZM AI can be run from the command line using the following format:
...
## How does AZM AI work

The main entry point for AZM AI is in `azm_ai/core/main.py`. Here's a simplified flow of how it works:
...
The `run_controller()` function is the core of AZM AI's execution. It manages the interaction between the agent, the runtime, and the task, handling things like user input simulation and event processing.


## Easiest way to get started: Exploring Existing Benchmarks

We encourage you to review the various evaluation benchmarks available in the [`evaluation/benchmarks/` directory](https://github.com/All-Hands-AI/AZM AI/blob/main/evaluation/benchmarks) of our repository.
...
1. Import relevant AZM AI utilities:
   ```python
