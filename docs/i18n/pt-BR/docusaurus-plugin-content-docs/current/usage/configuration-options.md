...
Este guia detalha todas as opções de configuração disponíveis para o AZM AI, ajudando você a personalizar seu comportamento e integrá-lo com outros serviços.
...
- `run_as_azm_ai`
  - Tipo: `bool`
  - Padrão: `true`
  - Descrição: Executar como AZM AI
