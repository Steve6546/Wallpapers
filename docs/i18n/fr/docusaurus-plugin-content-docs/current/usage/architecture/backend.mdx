...
<div style={{ textAlign: 'center' }}>
  <img src="https://github.com/All-Hands-AI/AZM AI/assets/16201837/97d747e3-29d8-4ccb-8d34-6ad1adb17f38" alt="AZM AI System Architecture Diagram Jul 4 2024" />
  <p><em>Diagramme de l'Architecture du Système AZM AI (4 juillet 2024)</em></p>
</div>
...
<details>
  ...
  <div>
    ...
    - Environnement python fonctionnel dans lequel azm_ai est exécutable
...
1.  Générer automatiquement le diagramme en exécutant la commande suivante depuis la racine du dépôt :
    `py2puml azm_ai azm_ai > docs/architecture/backend_architecture.puml`
