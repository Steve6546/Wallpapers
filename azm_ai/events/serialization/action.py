...
from azm_ai.core.exceptions import LLMMalformedActionError
...
from azm_ai.events.action.commands import (
    CmdRunAction,
...
def handle_action_deprecated_args(args: dict[str, Any]) -> dict[str, Any]:
    # keep_prompt has been deprecated in https://github.com/All-Hands-AI/AZM AI/pull/4881
