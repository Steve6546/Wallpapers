...
from azm_ai.events.serialization.event import event_to_trajectory, truncate_content
...
class AgentController:
    ...
    async def start_delegate(self, action: AgentDelegateAction) -> None:
        ...
        AZM AI is a multi-agentic system. A `task` is a conversation between
        AZM AI (the whole system) and the user, which might involve one or more inputs
