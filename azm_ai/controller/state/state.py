...
import azm_ai
from azm_ai.controller.state.task import RootTask
...
from azm_ai.events.action.agent import AgentFinishAction
from azm_ai.events.event import Event, EventSource
from azm_ai.llm.metrics import Metrics
from azm_ai.memory.view import View
from azm_ai.storage.files import FileStore
from azm_ai.storage.locations import get_conversation_agent_state_filename
...
class State:
    """
    Represents the running state of an agent in the AZM AI system, saving data of its operation and memory.
    ...
    def to_llm_metadata(self, agent_name: str) -> dict:
        return {
            ...
            'trace_version': azm_ai.__version__,
            'tags': [
                f'agent:{agent_name}',
                f"web_host:{os.environ.get('WEB_HOST', 'unspecified')}",
                f'azm_ai_version:{azm_ai.__version__}',
            ],
        }
