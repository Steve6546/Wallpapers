# Configuration Management in AZM AI

## Overview

AZM AI uses a flexible configuration system that allows settings to be defined through environment variables, TOML files, and command-line arguments. The configuration is managed through a package structure in `azm_ai/core/config/`.
...
While this document focuses on environment variable configuration, AZM AI also supports:
...
The AZM AI configuration system provides a flexible and type-safe way to manage application settings. By following the naming conventions and utilizing the provided functions, developers can easily customize the behavior of AZM AI components through environment variables and other configuration sources.
