...
from azm_ai.core.logger import DEBUG, DEBUG_RUNTIME
from azm_ai.core.logger import azm_ai_logger as logger
from azm_ai.events import EventStream
from azm_ai.runtime.builder import DockerRuntimeBuilder
from azm_ai.runtime.impl.action_execution.action_execution_client import (
    ActionExecutionClient,
)
from azm_ai.runtime.impl.docker.containers import stop_all_containers
...
from azm_ai.runtime.utils.log_streamer import LogStreamer
from azm_ai.runtime.utils.runtime_build import build_runtime_image
from azm_ai.utils.async_utils import call_sync_from_async
from azm_ai.utils.shutdown_listener import add_shutdown_listener
from azm_ai.utils.tenacity_stop import stop_if_should_exit

CONTAINER_NAME_PREFIX = 'azm-ai-runtime-'
...
class DockerRuntime(ActionExecutionClient):
    ...
    def _init_container(self):
        ...
        if (
            ...
            # e.g. result would be: {"/home/user/azm_ai/workspace": {'bind': "/workspace", 'mode': 'rw'}}
            volumes = {
        ...
        try:
            self.container = self.docker_client.containers.run(
                ...
                ports=port_mapping,
                working_dir='/azm_ai/code/',  # do not change this!
    ...
    def close(self, rm_all_containers: bool | None = None):
        ...
        Parameters:
        - rm_all_containers (bool): Whether to remove all containers with the 'azm-ai-sandbox-' prefix
        """
        super().close()
