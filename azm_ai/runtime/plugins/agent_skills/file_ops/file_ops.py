"""File operations module for AZM AI agent.

This module provides a collection of file manipulation skills that enable the AZM AI
...
from azm_ai.linter import DefaultLinter, LintResult
