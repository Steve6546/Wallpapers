...
from azm_ai.microagent.types import MicroagentMetadata, MicroagentType
...
class BaseMicroagent(BaseModel):
    ...
    def load(
        ...
        # Legacy repo instructions are stored in .azm_ai_instructions
        if path.name == '.azm_ai_instructions':
...
class RepoMicroagent(BaseMicroagent):
    ...
    RepoMicroagents are loaded from `.azm_ai/microagents/repo.md` files within repositories
...
def load_microagents_from_dir(
    ...
    Args:
        microagent_dir: Path to the microagents directory (e.g. .azm_ai/microagents)
    ...
    # Load all agents from .azm_ai/microagents directory
