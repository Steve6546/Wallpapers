...
from azm_ai.core.exceptions import LLMResponseError
from azm_ai.events.event import Event
from azm_ai.events.observation import CmdOutputMetadata
from azm_ai.events.serialization import event_to_dict
from azm_ai.llm.metrics import Metrics


class AZM AIJSONEncoder(json.JSONEncoder):
...
_json_encoder = AZM AIJSONEncoder()
...
def dumps(obj, **kwargs):
    ...
    if 'cls' not in encoder_kwargs:
        encoder_kwargs['cls'] = AZM AIJSONEncoder
