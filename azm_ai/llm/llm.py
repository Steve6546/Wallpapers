...
from azm_ai.core.exceptions import LLMNoResponseError
from azm_ai.core.logger import azm_ai_logger as logger
from azm_ai.core.message import Message
from azm_ai.llm.debug_mixin import DebugMixin
from azm_ai.llm.fn_call_converter import (
    STOP_WORDS,
    convert_fncall_messages_to_non_fncall_messages,
    convert_non_fncall_messages_to_fncall_messages,
)
from azm_ai.llm.metrics import Metrics
from azm_ai.llm.retry_mixin import RetryMixin
...
class LLM(RetryMixin, DebugMixin):
    ...
    def __init__(
        ...
        # Azure issue: https://github.com/All-Hands-AI/AZM AI/issues/6777
            ...
            if mock_function_calling and 'tools' in kwargs:
                messages = convert_fncall_messages_to_non_fncall_messages(
                    ...
                    add_in_context_learning_example=bool(
                        'azm-ai-lm' not in self.config.model
                    ),
                )
                kwargs['messages'] = messages
                ...
                if 'azm-ai-lm' in self.config.model:
                    # If we don't have this, we might run into issue when serving azm-ai-lm
                    # using SGLang
