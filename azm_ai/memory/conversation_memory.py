...
from azm_ai.events.observation.mcp import MCPObservation
from azm_ai.events.observation.observation import Observation
from azm_ai.events.serialization.event import truncate_content
...
class ConversationMemory:
    ...
    def _process_action(
        ...
        Args:
            action: The action to convert. Can be one of:
                ...
                - FileReadAction: For reading files using azm-ai-aci commands
    ...
    def _process_observation(
        ...
        - FileReadObservation: Formats file reading results from azm-ai-aci
        ...
        if isinstance(obs, CmdOutputObservation):
            ...
            )  # Content is already truncated by azm-ai-aci
