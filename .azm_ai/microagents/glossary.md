...
### Agent
The core AI entity in AZM AI that can perform software development tasks by interacting with tools, browsing the web, and modifying code.
...
#### CodeAct Agent
[A generalist agent in AZM AI](https://arxiv.org/abs/2407.16741) designed to perform tasks by editing and executing code.
...
Settings that control various aspects of AZM AI behavior, including runtime, security, and agent settings.
...
### Interface
Different ways to interact with AZM AI.

#### CLI Mode
A command-line interface mode for interacting with AZM AI agents without a graphical interface.

#### GUI Mode
A graphical user interface mode for interacting with AZM AI agents through a web interface.

#### Headless Mode
A mode of operation where AZM AI runs without a user interface, suitable for automation and scripting.
...
### Microagent
A specialized prompt that enhances AZM AI with domain-specific knowledge, repository-specific context, and task-specific workflows.

#### Microagent Registry
A central repository of available microagents and their configurations.

#### Public Microagent
A general-purpose microagent available to all AZM AI users, triggered by specific keywords.

#### Repository Microagent
A type of microagent that provides repository-specific context and guidelines, stored in the `.azm_ai/microagents/` directory.
