...
from azm_ai.core.logger import azm_ai_logger
...
def test_compat_env_to_config(monkeypatch, setup_env):
    ...
    monkeypatch.setenv('WORKSPACE_BASE', '/repos/azm_ai/workspace')
    ...
    assert config.workspace_base == '/repos/azm_ai/workspace'
...
[llm]
# Not set in `azm_ai/core/schema/config.py`
invalid_field = "test"
model = "gpt-4"
