from azm_ai.core.schema.observation import ObservationType
...
from azm_ai.events.observation.agent import MicroagentKnowledge
from azm_ai.events.serialization import (
    event_from_dict,
    event_to_dict,
    event_to_trajectory,
)
from azm_ai.events.serialization.observation import observation_from_dict
...
def test_microagent_observation_environment_serialization():
    ...
    original = RecallObservation(
        ...
        repo_name='AZM AI',
        repo_directory='/workspace/azm_ai',
    ...
    assert serialized['extras']['repo_name'] == 'AZM AI'
