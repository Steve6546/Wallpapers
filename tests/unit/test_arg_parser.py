...
from azm_ai.core.config import AZM_DEFAULT_AGENT, AZM_MAX_ITERATIONS, get_parser
...
def test_parser_default_values():
    ...
    assert args.agent_cls == AZM_DEFAULT_AGENT
    assert args.max_iterations == AZM_MAX_ITERATIONS
