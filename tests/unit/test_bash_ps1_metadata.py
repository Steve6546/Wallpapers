...
###PS1JSON###
{
  ...
  "working_dir": "/home/runner/work/AZM AI/AZM AI",
  "py_interpreter_path": "/home/runner/.cache/pypoetry/virtualenvs/azm_ai-ai-ULPBlkAi-py3.12/bin/python"
}
###PS1END###
"""
    matches = CmdOutputMetadata.matches_ps1_metadata(ps1_str)
    ...
    assert metadata.working_dir == '/home/runner/work/AZM AI/AZM AI'
    assert (
        metadata.py_interpreter_path
        == '/home/runner/.cache/pypoetry/virtualenvs/azm_ai-ai-ULPBlkAi-py3.12/bin/python'
    )
