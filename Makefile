...
@poetry run pre-commit run --files azm_ai/**/* agenthub/**/* evaluation/**/* --show-diff-on-failure --config $(PRE_COMMIT_CONFIG_PATH)
...
@poetry run uvicorn azm_ai.server.listen:app --host $(BACKEND_HOST) --port $(BACKEND_PORT) --reload --reload-exclude "./workspace"
...
@poetry run uvicorn azm_ai.server.listen:app --host $(BACKEND_HOST) --port $(BACKEND_PORT) &
...
@echo "  $(GREEN)setup-config$(RESET)        - Setup the configuration for AZM AI by providing LLM API key,"
@echo "                        LLM Model name, and workspace directory."
@echo "  $(GREEN)start-backend$(RESET)       - Start the backend server for the AZM AI project."
@echo "  $(GREEN)start-frontend$(RESET)      - Start the frontend server for the AZM AI project."
@echo "  $(GREEN)run$(RESET)                 - Run the AZM AI application, starting both backend and frontend servers."
@echo "                        Backend Log file will be stored in the 'logs' directory."
@echo "  $(GREEN)docker-dev$(RESET)          - Build and run the AZM AI application in Docker."
@echo "  $(GREEN)docker-run$(RESET)          - Run the AZM AI application, starting both backend and frontend servers in Docker."
