...
export enum I18nKey {
  ...
  CONFIGURATION$AZM_AI_WORKSPACE_DIRECTORY_INPUT_LABEL = "CONFIGURATION$AZM_AI_WORKSPACE_DIRECTORY_INPUT_LABEL",
  ...
  LLM$MODEL = "LLM$MODEL",
  CONFIGURATION$AZM_AI_WORKSPACE_DIRECTORY_INPUT_PLACEHOLDER = "CONFIGURATION$AZM_AI_WORKSPACE_DIRECTORY_INPUT_PLACEHOLDER",
