...
describe("ConversationPanel", () => {
  ...
  beforeEach(() => {
    ...
    vi.spyOn(AZM AI, "getUserConversations").mockResolvedValue([...mockConversations]);
  });
  ...
  it("should display an empty state when there are no conversations", async () => {
    const getUserConversationsSpy = vi.spyOn(AZM AI, "getUserConversations");
  ...
  it("should call endSession after deleting a conversation that is the current session", async () => {
    ...
    const deleteUserConversationSpy = vi.spyOn(AZM AI, "deleteUserConversation");
