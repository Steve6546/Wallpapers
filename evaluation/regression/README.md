# AZM AI - Regression Test Framework

AZM AI project is an open-source software engineering AI that can solve various software engineering tasks. This repository contains the regression test framework for AZM AI project.

## Running the Tests

To run the tests for AZM AI project, you can use the provided test runner script. Follow these steps:
...
The test cases for AZM AI project are organized in the `cases/` directory. Each test case has the following structure:
...
- `outputs/`: This directory contains the output generated by AZM AI for each agent.
- `outputs/*/workspace/`: This directory contains the actual output files generated by AZM AI.
- `test_*.py`: These are the test scripts that validate the output of AZM AI.
...
- `run_test_case`: A fixture that runs AZM AI and generates the workspace for the current test case.
