...
- `git-version`: The git commit hash or release tag of AZM AI to evaluate (e.g., `HEAD` or `0.6.2`)
...
1. Fork [our HuggingFace evaluation outputs](https://huggingface.co/spaces/AZM AI/evaluation).
...
- [AZM AI Documentation](https://github.com/All-Hands-AI/AZM AI)
- [HuggingFace Datasets](https://huggingface.co/datasets)

For any questions or issues, please open an issue in the [AZM AI repository](https://github.com/All-Hands-AI/AZM AI/issues).
